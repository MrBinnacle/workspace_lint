/* THROWAWAY. Disposition, ratios and exit byte — ADR-0005 decision 3 and
 * ADR-0008 decision 2.
 *
 * Extracted from live-ref001.ts so the live run and the offline checks execute
 * the SAME implementation. results-ref001-live.md §4 records what happens when
 * they do not: the manifest and the exit byte were maintained independently,
 * drifted, and drifted toward the flattering answer.
 */
