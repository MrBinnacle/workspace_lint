...
5. **`docs/research/`** — the evidence the ADRs were built from. **Read before asserting any factual
   ...
   question it answers and what it refutes. The count is claim-gated, not written out; the index is what makes "read the
...
└── docs/
    ...
    ├── research/           ← documented evidence (20 files; start at INDEX.md)
